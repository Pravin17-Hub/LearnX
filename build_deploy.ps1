...
if ($JavaFiles.Count -eq 0) {
    ...
    $Classpath = ".;$TomcatLib\servlet-api.jar;$TomcatLib\jsp-api.jar;$TomcatLib\tomcat-dbcp.jar;$TomcatLib\websocket-api.jar;$LibDir\mysql-connector-j-8.3.0.jar;$LibDir\gson-2.11.0.jar"
